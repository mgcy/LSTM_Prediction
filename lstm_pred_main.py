...
# load the data and train the LSTM iteratively, deal with upper part first
look_back = 2
test_index = 175

# get the number of files in upper folder
path, dirs, files = next(os.walk("D:\Academic\lstm_prediction\overlap_data\\upper"))
...
for i1 in range(1, up_file_count + 1):
    # get the dir of data
    up_dir = 'D:\Academic\lstm_prediction\overlap_data\\upper\\' + str(i1) + '.txt'
    print(up_dir)
    # load the dataset
